...
directory = '/home/awickert/Dropbox/Papers/InProgress/ChannelWidth/dakota_cannon_from1991/logvars/out/run.'+run_number+'/'
...
# Observations #
################
obs = pd.read_csv('CannonWelch_Width_1991onwards.tsv',
                  sep=None)
